            ...
            runs: [
                {
                    ...
                    field: "pop_size",
                    distance: 1239682,
                    data: [[19, 12, 7, 22, 8, 6, 5], [13, 4, 2, 11, 16, 17, 1, 15, 21, 9, 18, 14, 3, 10, 20]],
                },
                {
                    fields: {
                        pop_size: 60,
                    ...
                    field: "pop_size",
                    distance: 1243257,
                    data: [[17, 21, 15, 3, 14, 22, 20, 1, 19, 6], [5, 12, 9, 10, 8, 4, 2, 16, 13, 18, 11, 7]],
                },
                {
                    fields: {
                        pop_size: 100,
                    ...
                    field: "pop_size",
                    distance: 1185679,
                    data: [[5, 17, 1, 16, 14, 15, 3, 9, 12, 19, 8, 20, 10, 22], [6, 2, 4, 13, 18, 11, 21, 7]],
                },
                {
                    fields: {
                        pop_size: 200,
                    ...
                    field: "pop_size",
                    distance: 1131496,
                    data: [[2, 9, 10, 4, 22, 12, 13, 8, 20, 3, 17, 21, 1], [7, 14, 16, 18, 15, 11, 6, 19, 5]],
                },
                // ----
                {
                    fields: {
                    ...
                    field: "maxnfc",
                    distance: 1190537,
                    data: [[6, 19, 7, 18, 16, 11, 10, 20, 15, 14], [9, 4, 12, 17, 21, 2, 3, 13, 22, 1, 8, 5]],
                },
                {
                    fields: {
                        pop_size: 200,
                    ...
                    field: "maxnfc",
                    distance: 1144531,
                    data: [[22, 1, 17, 4, 10, 20, 2, 19, 5], [8, 21, 9, 18, 12, 7, 14, 3, 11, 15, 16, 13, 6]],
                },
                {
                    fields: {
                        pop_size: 200,
                    ...
                    field: "maxnfc",
                    distance: 1067751,
                    data: [[8, 13, 3, 6, 10, 5], [15, 11, 14, 12, 2, 20, 22, 1, 9, 7, 19, 4, 17, 21, 18, 16]],
                },
                {
                    fields: {
                        pop_size: 200,
                    ...
                    field: "maxnfc",
                    distance: 1050630,
                    data: [[4, 9, 16, 14, 3, 7, 6, 1, 22], [17, 11, 15, 18, 2, 21, 12, 20, 10, 8, 13, 19, 5]],
                },
            ]
        }
    },
            ...
            runs: [
                {
                    ...
                    field: "maxnfc",
                    distance: 6699242,
                    data: [[21,7,12,18,11,3,9 ], [5,13,22,2,4,15,14,19,16,17,1,10,20,6,8]],
                },
                {
                    fields: {
                        pop_size: 100,
                    ...
                    field: "maxnfc",
                    distance: 6206285,
                    data: [[17,18,21,10,13,7,14,19,8,4,9], [20,16,15,6,1,3,11,22,2,12,5]],
                },
                {
                    fields: {
                        pop_size: 200,
                    ...
                    field: "pop_size",
                    distance: 6579542,
                    data: [[13,2,3,21,15,9,4,18,11 ], [5,8,10,16,17,12,19,14,20,7,6,1,22]],
                },
                {
                    fields: {
                        pop_size: 300,
                    ...
                    field: "pop_size",
                    distance: 6227816,
                    data: [[16,20,17,1,14,19,15,2,3,6,4,10,21,8,9], [11,7,18,22,5,13,12 ]],
                },
                {
                    fields: {
                        pop_size: 400,
                    ...
                    field: "pop_size",
                    distance: 6380647,
                    data: [[12,11,14,19,21 ], [3,16,17,1,8,6,22,10,18,15,20,7,5,2]],
                },
                // ----
                {
                    fields: {
                    ...
                    field: "maxnfc",
                    distance: 23681116,
                    data: [[10,7,22,4,42,17,29,13,43,5,6 ], [34,46,20,3,27,47,21,41,40,18,23,48 ], [15,49,2,9,45,31,38,24,35,30 ], [33,39,36,32,25,19,12,8,1,26,14,16,37,44,11,28]],
                },
                {
                    fields: {
                        pop_size: 100,
                    ...
                    field: "maxnfc",
                    distance: 25504756,
                    data: [[49,31,37,6,8,21,14,42,36,33,28,7,47], [26,4,40,25,23,10,22,2,24,48], [32,27,39,43,30,44,3,18,5,46,13,12 ], [29,20,15,38,35,16,19,17,1,45,9,41,34,11]],
                },
                {
                    fields: {
                        pop_size: 200,
                    ...
                    field: "maxnfc",
                    distance: 24331860,
                    data: [[14,4,42,26,3,18,32,27,43,17,22], [23,11,39,2,38,5,8,37,40,24,47,44], [48,7,28,21,12,33,34,20,35,31], [10,1,30,36,46,41,49,6,9,16,25,29,13,15,45,19]],
                },
                {
                    fields: {
                        pop_size: 200,
                    ...
                    field: "maxnfc",
                    distance: 25504831,
                    data: [[40,16,14,26,35,29,41,12,23,36,30,18,6,48,37], [38,43,1,2,17,31,9,32,28,25,5], [19,13,27,49,11,3,8,44,4,42,20,45], [33,21,24,7,22,47,15,46,10,39,34]],
                },
            ]
        }
    },
